...
urlwatch -v --hooks config/hooks.py --urls housing_fullhtml/urls.yaml --config housing_fullhtml/urlwatch.yaml --cache housing_fullhtml/cache.db 2> housing_fullhtml/urlwatch_debug.log 1> housing_fullhtml/urlwatch_output.log
